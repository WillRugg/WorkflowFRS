...
<!--<input type="hidden" name="controller" value="index" /> 
    	...
    	<fieldset class="col-sm-12 control-label thumbnail">
	 		<div class="form-group col-sm-12">
			    ...
			    <div class="form-group col-sm-4">
			        <input type="text"  class="form-control" id="nbreEmployes" name="nbreEmployes"  value="<?php echo $UnFournisseur['nbEmployes'];?>" size="5" maxlength="5" placeholder="Nbre employés"> 	
			    </div>	
		   		<div class="form-group col-sm-4">
