...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		prevText: "Suiv", // Display text for previous month link
		nextText: "Préc", // Display text for next month link
		...
		monthNamesShort: [ "Jan", "Fév", "Mar", "Avr", "Mai", "Jun", "Jul", "Ao", "Sep", "Oct", "Nov", "Dec" ], // For formatting
